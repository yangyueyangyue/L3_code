...
#define HD_MAP_TYPE HD_MAP_TYPE_APOLLO
...
// Define vehicle motion control implementation method
#define CONTROLLER_LATERAL_DFCV (1)
#define CONTROLLER_LATERAL_GOYU (2)
#define CONTROLLER_LATERAL CONTROLLER_LATERAL_GOYU

#define CONTROLLER_LONGITUDINAL_DFCV (1)
#define CONTROLLER_LONGITUDINAL_GOYU (2)
#define CONTROLLER_LONGITUDINAL CONTROLLER_LONGITUDINAL_DFCV
