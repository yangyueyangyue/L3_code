...
enum Chassis_TrailerStatus : int {
  Chassis_TrailerStatus_TRAILER_STATUS_NOT_CONNECTED = 0,
  Chassis_TrailerStatus_TRAILER_STATUS_CONNECTED = 1
};
bool Chassis_TrailerStatus_IsValid(int value);
constexpr Chassis_TrailerStatus Chassis_TrailerStatus_TrailerStatus_MIN = Chassis_TrailerStatus_TRAILER_STATUS_NOT_CONNECTED;
constexpr Chassis_TrailerStatus Chassis_TrailerStatus_TrailerStatus_MAX = Chassis_TrailerStatus_TRAILER_STATUS_CONNECTED;
constexpr int Chassis_TrailerStatus_TrailerStatus_ARRAYSIZE = Chassis_TrailerStatus_TrailerStatus_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Chassis_TrailerStatus_descriptor();
template<typename T>
inline const std::string& Chassis_TrailerStatus_Name(T enum_t_value) {
  static_assert(::std::is_same<T, Chassis_TrailerStatus>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function Chassis_TrailerStatus_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    Chassis_TrailerStatus_descriptor(), enum_t_value);
}
inline bool Chassis_TrailerStatus_Parse(
    const std::string& name, Chassis_TrailerStatus* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<Chassis_TrailerStatus>(
    Chassis_TrailerStatus_descriptor(), name, value);
}
// ===================================================================
...
class Chassis :
 ...
 public:
  ...
  typedef Chassis_TrailerStatus TrailerStatus;
  static constexpr TrailerStatus TRAILER_STATUS_NOT_CONNECTED =
    Chassis_TrailerStatus_TRAILER_STATUS_NOT_CONNECTED;
  static constexpr TrailerStatus TRAILER_STATUS_CONNECTED =
    Chassis_TrailerStatus_TRAILER_STATUS_CONNECTED;
  static inline bool TrailerStatus_IsValid(int value) {
    return Chassis_TrailerStatus_IsValid(value);
  }
  static constexpr TrailerStatus TrailerStatus_MIN =
    Chassis_TrailerStatus_TrailerStatus_MIN;
  static constexpr TrailerStatus TrailerStatus_MAX =
    Chassis_TrailerStatus_TrailerStatus_MAX;
  static constexpr int TrailerStatus_ARRAYSIZE =
    Chassis_TrailerStatus_TrailerStatus_ARRAYSIZE;
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  TrailerStatus_descriptor() {
    return Chassis_TrailerStatus_descriptor();
  }
  template<typename T>
  static inline const std::string& TrailerStatus_Name(T enum_t_value) {
    static_assert(::std::is_same<T, TrailerStatus>::value ||
      ::std::is_integral<T>::value,
      "Incorrect type passed to function TrailerStatus_Name.");
    return Chassis_TrailerStatus_Name(enum_t_value);
  }
  static inline bool TrailerStatus_Parse(const std::string& name,
      TrailerStatus* value) {
    return Chassis_TrailerStatus_Parse(name, value);
  }
  ...
  enum : int {
    ...
    kGrossWeightValidFieldNumber = 47,
    kGrossWeightFieldNumber = 48,
    kTrailerStatusFieldNumber = 49,
  };
  ...
  // optional bool gross_weight_valid = 47 [default = false];
  bool has_gross_weight_valid() const;
  void clear_gross_weight_valid();
  bool gross_weight_valid() const;
  void set_gross_weight_valid(bool value);

  // optional float gross_weight = 48 [default = 0];
  bool has_gross_weight() const;
  void clear_gross_weight();
  float gross_weight() const;
  void set_gross_weight(float value);

  // optional .phoenix.msg.control.Chassis.TrailerStatus trailer_status = 49 [default = TRAILER_STATUS_NOT_CONNECTED];
  bool has_trailer_status() const;
  void clear_trailer_status();
  ::phoenix::msg::control::Chassis_TrailerStatus trailer_status() const;
  void set_trailer_status(::phoenix::msg::control::Chassis_TrailerStatus value);
...
// optional bool gross_weight_valid = 47 [default = false];
inline bool Chassis::has_gross_weight_valid() const {
  return (_has_bits_[1] & 0x00004000u) != 0;
}
inline void Chassis::clear_gross_weight_valid() {
  gross_weight_valid_ = false;
  _has_bits_[1] &= ~0x00004000u;
}
inline bool Chassis::gross_weight_valid() const {
  // @@protoc_insertion_point(field_get:phoenix.msg.control.Chassis.gross_weight_valid)
  return gross_weight_valid_;
}
inline void Chassis::set_gross_weight_valid(bool value) {
  _has_bits_[1] |= 0x00004000u;
  gross_weight_valid_ = value;
  // @@protoc_insertion_point(field_set:phoenix.msg.control.Chassis.gross_weight_valid)
}

// optional float gross_weight = 48 [default = 0];
inline bool Chassis::has_gross_weight() const {
  return (_has_bits_[1] & 0x00008000u) != 0;
}
inline void Chassis::clear_gross_weight() {
  gross_weight_ = 0;
  _has_bits_[1] &= ~0x00008000u;
}
inline float Chassis::gross_weight() const {
  // @@protoc_insertion_point(field_get:phoenix.msg.control.Chassis.gross_weight)
  return gross_weight_;
}
inline void Chassis::set_gross_weight(float value) {
  _has_bits_[1] |= 0x00008000u;
  gross_weight_ = value;
  // @@protoc_insertion_point(field_set:phoenix.msg.control.Chassis.gross_weight)
}

// optional .phoenix.msg.control.Chassis.TrailerStatus trailer_status = 49 [default = TRAILER_STATUS_NOT_CONNECTED];
inline bool Chassis::has_trailer_status() const {
  return (_has_bits_[1] & 0x00010000u) != 0;
}
inline void Chassis::clear_trailer_status() {
  trailer_status_ = 0;
  _has_bits_[1] &= ~0x00010000u;
}
inline ::phoenix::msg::control::Chassis_TrailerStatus Chassis::trailer_status() const {
  // @@protoc_insertion_point(field_get:phoenix.msg.control.Chassis.trailer_status)
  return static_cast< ::phoenix::msg::control::Chassis_TrailerStatus >(trailer_status_);
}
inline void Chassis::set_trailer_status(::phoenix::msg::control::Chassis_TrailerStatus value) {
  assert(::phoenix::msg::control::Chassis_TrailerStatus_IsValid(value));
  _has_bits_[1] |= 0x00010000u;
  trailer_status_ = value;
  // @@protoc_insertion_point(field_set:phoenix.msg.control.Chassis.trailer_status)
}
...
template <> struct is_proto_enum< ::phoenix::msg::control::Chassis_TrailerStatus> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::phoenix::msg::control::Chassis_TrailerStatus>() {
  return ::phoenix::msg::control::Chassis_TrailerStatus_descriptor();
}
