...
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_chassis_2eproto[11];
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_chassis_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::phoenix::msg::control::Chassis, gross_weight_valid_),
  PROTOBUF_FIELD_OFFSET(::phoenix::msg::control::Chassis, gross_weight_),
  PROTOBUF_FIELD_OFFSET(::phoenix::msg::control::Chassis, trailer_status_),
  0,
  1,
  2,
  3,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 54, sizeof(::phoenix::msg::control::Chassis)},
};
...
const char descriptor_table_protodef_chassis_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "lse\022\030\n\rengine_torque\030. \001(\002:\0010\022!\n\022gross_w"
  "eight_valid\030/ \001(\010:\005false\022\027\n\014gross_weight"
  "\0300 \001(\002:\0010\022`\n\016trailer_status\0301 \001(\0162*.phoe"
  "nix.msg.control.Chassis.TrailerStatus:\034T"
  "RAILER_STATUS_NOT_CONNECTED\"Z\n\013DrivingMo"
  "de\022\030\n\024DRIVING_MODE_INVALID\020\000\022\027\n\023DRIVING_"
  "MODE_MANUAL\020\001\022\030\n\024DRIVING_MODE_ROBOTIC\020\002\""
  ":\n\005EStop\022\022\n\016E_STOP_INVALID\020\000\022\016\n\nE_STOP_O"
  "FF\020\001\022\r\n\tE_STOP_ON\020\002\"\211\001\n\tEpsStatus\022\026\n\022EPS"
  "_STATUS_INVALID\020\000\022\025\n\021EPS_STATUS_MANUAL\020\001"
  "\022\026\n\022EPS_STATUS_ROBOTIC\020\002\022\037\n\033EPS_STATUS_M"
  "ANUAL_INTERRUPT\020\003\022\024\n\020EPS_STATUS_ERROR\020\004\""
  "\224\001\n\021ThrottleSysStatus\022\037\n\033THROTTLE_SYS_ST"
  "ATUS_INVALID\020\000\022\036\n\032THROTTLE_SYS_STATUS_MA"
  "NUAL\020\001\022\037\n\033THROTTLE_SYS_STATUS_ROBOTIC\020\002\022"
  "\035\n\031THROTTLE_SYS_STATUS_ERROR\020\003\"h\n\tEbsSta"
  "tus\022\026\n\022EBS_STATUS_INVALID\020\000\022\025\n\021EBS_STATU"
  "S_MANUAL\020\001\022\026\n\022EBS_STATUS_ROBOTIC\020\002\022\024\n\020EB"
  "S_STATUS_ERROR\020\003\"P\n\014GearPosition\022\020\n\014GEAR"
  "_INVALID\020\000\022\n\n\006GEAR_P\020\001\022\n\n\006GEAR_N\020\002\022\n\n\006GE"
  "AR_R\020\003\022\n\n\006GEAR_D\020\004\"9\n\nSignalLamp\022\020\n\014LAMP"
  "_INVALID\020\000\022\014\n\010LAMP_OFF\020\001\022\013\n\007LAMP_ON\020\002\"|\n"
  ...
  "\017TURN_LAMP_RIGHT\020\003\022\027\n\023TURN_LAMP_EMERGENC"
  "Y\020\004\"\214\001\n\026SignalTurningIndicator\022\035\n\031TURNIN"
  "G_INDICATOR_INVALID\020\000\022\032\n\026TURNING_INDICAT"
  "OR_NONE\020\001\022\032\n\026TURNING_INDICATOR_LEFT\020\002\022\033\n"
  "\027TURNING_INDICATOR_RIGHT\020\003\"J\n\tEpbStatus\022"
  "\026\n\022EPB_STATUS_INVALID\020\000\022\022\n\016EPB_STATUS_OF"
  "F\020\001\022\021\n\rEPB_STATUS_ON\020\002\"O\n\rTrailerStatus\022"
  " \n\034TRAILER_STATUS_NOT_CONNECTED\020\000\022\034\n\030TRA"
  "ILER_STATUS_CONNECTED\020\001"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_chassis_2eproto = {
  &descriptor_table_chassis_2eproto_initialized, descriptor_table_protodef_chassis_2eproto, "chassis.proto", 3303,
...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Chassis_TrailerStatus_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_chassis_2eproto);
  return file_level_enum_descriptors_chassis_2eproto[10];
}
...
#if (__cplusplus < 201703) && (!defined(_MSC_VER) || _MSC_VER >= 1900)
constexpr Chassis_TrailerStatus Chassis::TRAILER_STATUS_NOT_CONNECTED;
constexpr Chassis_TrailerStatus Chassis::TRAILER_STATUS_CONNECTED;
constexpr Chassis_TrailerStatus Chassis::TrailerStatus_MIN;
constexpr Chassis_TrailerStatus Chassis::TrailerStatus_MAX;
constexpr int Chassis::TrailerStatus_ARRAYSIZE;
#endif  // (__cplusplus < 201703) && (!defined(_MSC_VER) || _MSC_VER >= 1900)
...
class Chassis::_Internal {
 public:
  ...
  static void set_has_gross_weight_valid(HasBits* has_bits) {
    (*has_bits)[1] |= 16384u;
  }
  static void set_has_gross_weight(HasBits* has_bits) {
    (*has_bits)[1] |= 32768u;
  }
  static void set_has_trailer_status(HasBits* has_bits) {
    (*has_bits)[1] |= 65536u;
  }
};
...
Chassis::Chassis(const Chassis& from)
  ...
  ::memcpy(&driving_mode_, &from.driving_mode_,
    static_cast<size_t>(reinterpret_cast<char*>(&trailer_status_) -
    reinterpret_cast<char*>(&driving_mode_)) + sizeof(trailer_status_));
...
void Chassis::SharedCtor() {
  ...
  ::memset(&header_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&trailer_status_) -
      reinterpret_cast<char*>(&header_)) + sizeof(trailer_status_));
}
...
// @@protoc_insertion_point(message_clear_start:phoenix.msg.control.Chassis)
  ...
  if (cached_has_bits & 0x0000ff00u) {
    ::memset(&signal_turn_lamp_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&gross_weight_) -
        reinterpret_cast<char*>(&signal_turn_lamp_)) + sizeof(gross_weight_));
  }
  trailer_status_ = 0;
  _has_bits_.Clear();
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 47:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 120)) {
          _Internal::set_has_gross_weight_valid(&_has_bits_);
          gross_weight_valid_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 48:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 133)) {
          _Internal::set_has_gross_weight(&_has_bits_);
          gross_weight_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else goto handle_unusual;
        continue;
      ...
      case 49:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 136)) {
          ::PROTOBUF_NAMESPACE_ID::uint64 val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::phoenix::msg::control::Chassis_TrailerStatus_IsValid(val))) {
            set_trailer_status(static_cast<::phoenix::msg::control::Chassis_TrailerStatus>(val));
          } else {
      ...
      case 49: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (392 & 0xFF)) {
          ...
          DO_((::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadPrimitive<
                   int, ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_ENUM>(
                 input, &value)));
          if (::phoenix::msg::control::Chassis_TrailerStatus_IsValid(value)) {
            set_trailer_status(static_cast< ::phoenix::msg::control::Chassis_TrailerStatus >(value));
          } else {
            mutable_unknown_fields()->AddVarint(
...
void Chassis::SerializeWithCachedSizes(
  ...
  // optional bool gross_weight_valid = 47 [default = false];
  if (cached_has_bits & 0x00004000u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBool(47, this->gross_weight_valid(), output);
  }

  // optional float gross_weight = 48 [default = 0];
  if (cached_has_bits & 0x00008000u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloat(48, this->gross_weight(), output);
  }

  // optional .phoenix.msg.control.Chassis.TrailerStatus trailer_status = 49 [default = TRAILER_STATUS_NOT_CONNECTED];
  if (cached_has_bits & 0x00010000u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteEnum(
      49, this->trailer_status(), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* Chassis::InternalSerializeWithCachedSizesToArray(
  ...
  // optional bool gross_weight_valid = 47 [default = false];
  if (cached_has_bits & 0x00004000u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(47, this->gross_weight_valid(), target);
  }

  // optional float gross_weight = 48 [default = 0];
  if (cached_has_bits & 0x00008000u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(48, this->gross_weight(), target);
  }

  // optional .phoenix.msg.control.Chassis.TrailerStatus trailer_status = 49 [default = TRAILER_STATUS_NOT_CONNECTED];
  if (cached_has_bits & 0x00010000u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteEnumToArray(
      49, this->trailer_status(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:phoenix.msg.control.Chassis)
  ...
  if (cached_has_bits & 0x00010000u) {
    total_size += 2 +
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::EnumSize(this->trailer_status());
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:phoenix.msg.control.Chassis)
  ...
  if (cached_has_bits & 0x0000ff00u) {
    ...
    if (cached_has_bits & 0x00004000u) {
      gross_weight_valid_ = from.gross_weight_valid_;
    }
    if (cached_has_bits & 0x00008000u) {
      gross_weight_ = from.gross_weight_;
    }
    _has_bits_[1] |= cached_has_bits;
  }
  if (cached_has_bits & 0x00010000u) {
    set_trailer_status(from.trailer_status());
  }
}
...
void Chassis::InternalSwap(Chassis* other) {
  ...
  swap(gross_weight_valid_, other->gross_weight_valid_);
  swap(gross_weight_, other->gross_weight_);
  swap(trailer_status_, other->trailer_status_);
}
