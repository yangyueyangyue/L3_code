...
private:
  ...
  public:
    ...
    void SetThreadFunc(UdpNode* comm_node, void (UdpNode::*func)(void)) {
      udp_node_ = comm_node;
      thread_func_ = func;
    }
  ...
  private:
    UdpNode* udp_node_;
    void (UdpNode::*thread_func_)(void);
  };
...
private:
  ...
  ThreadFuncHelper receiving_thread_func_helper_;
