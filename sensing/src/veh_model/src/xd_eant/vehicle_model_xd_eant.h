 ...
 ******************************************************************************/
#ifndef PHOENIX_VEH_MODEL_VEHICLE_MODEL_XD_EANT_H_
#define PHOENIX_VEH_MODEL_VEHICLE_MODEL_XD_EANT_H_
...
class VehicleModelXdEAnt : public VehicleModelBase {
public:
  typedef VehicleModelBase::Scalar Scalar;
  typedef VehicleModelBase Base;

public:
  virtual ~VehicleModelXdEAnt();
...
private:
  DECLARE_SINGLETON(VehicleModelXdEAnt);
};
...
#endif  // PHOENIX_VEH_MODEL_VEHICLE_MODEL_XD_EANT_H_
