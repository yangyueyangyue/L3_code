 ...
 ******************************************************************************/
#ifndef PHOENIX_VEH_MODEL_VEHICLE_MODEL_FT_AUMAN_H_
#define PHOENIX_VEH_MODEL_VEHICLE_MODEL_FT_AUMAN_H_
...
class VehicleModelFtAuman : public VehicleModelBase {
public:
  typedef VehicleModelBase::Scalar Scalar;
  typedef VehicleModelBase Base;

public:
  virtual ~VehicleModelFtAuman();
...
private:
  DECLARE_SINGLETON(VehicleModelFtAuman);
};
...
#endif  // PHOENIX_VEH_MODEL_VEHICLE_MODEL_FT_AUMAN_H_
