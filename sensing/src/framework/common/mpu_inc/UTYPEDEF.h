 ...
 *  @version    [00]  14.09.02   T.Takami  �����쐬
 *  @version    [01]  15.03.30   T.Takami  0,1�l��(boolean)��t��(QAC�΍�)
 *  @version    [02]  15.11.28   M.Murakawa   Doxygen�R�����g
 *  @version    [03]  18.05.04   HIENG   L53H_RCar_�f�[�^�\���d�l.xlsx��17,18,19�ŕύX�Ή�
**********************************************************************/
#ifndef UTYPEDEF_H
#define	UTYPEDEF_H
...
#define	BYTE8		 8u		/* 8�޲Ė�  */
#define	BYTE9		 9u		/* 9�޲Ė�  */
#define	BYTE10		10u		/* 10�޲Ė�  */
#define	BYTE11		11u		/* 11�޲Ė�  */
#define	BYTE12		12u		/* 12�޲Ė�  */
...
typedef enum
{
	...
	TYPE_HWORD,	/* Half Word(2byte)�^ */
	TYPE_WORD	/* Word(4byte)�^      */
}EN_SIZE_TYPE;
...
#define IS_4BYTE_ALIGN(X)	(((X) & 0x03u)==0u)	/* �A�h���XX��4byte���E���ۂ� */
#define IS_2BYTE_ALIGN(X)	(((X) & 0x01u)==0u)	/* �A�h���XX��2byte���E���ۂ� */
