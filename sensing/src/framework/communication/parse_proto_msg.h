...
public:
  ...
  // AD_HMI rosbag
  bool DecodeADHMIFusionObstacleListMessage(
      const Char_t* msg, Int32_t msg_len, 
      ad_msg::ObstacleList* data_out);
