...
const char descriptor_table_protodef_modules_2fmap_2fproto_2fmap_5fcrosswalk_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
...
Crosswalk::_Internal::id(const Crosswalk* msg) {
  return *msg->id_;
}
const ::apollo::hdmap::Polygon&
Crosswalk::_Internal::polygon(const Crosswalk* msg) {
  return *msg->polygon_;
}
