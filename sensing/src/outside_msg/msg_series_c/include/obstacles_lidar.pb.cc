...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_obstacles_5flidar_2eproto = {
  &descriptor_table_obstacles_5flidar_2eproto_initialized, descriptor_table_protodef_obstacles_5flidar_2eproto, "obstacles_lidar.proto", 1065,
