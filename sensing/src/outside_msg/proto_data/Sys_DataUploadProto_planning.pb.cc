...
extern PROTOBUF_INTERNAL_EXPORT_Sys_5fDataUploadProto_5fplanning_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<8> scc_info_DrivingMapInfo_message_Sys_5fDataUploadProto_5fplanning_2eproto;
...
class SpdPln_Display_Data_messageDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<SpdPln_Display_Data_message> _instance;
...
class DrivingMapInfo_messageDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<DrivingMapInfo_message> _instance;
...
static void InitDefaultsscc_info_DrivingMapInfo_message_Sys_5fDataUploadProto_5fplanning_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::phoenix::ad_data_upload::_DrivingMapInfo_message_default_instance_;
    new (ptr) ::phoenix::ad_data_upload::DrivingMapInfo_message();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::phoenix::ad_data_upload::DrivingMapInfo_message::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<8> scc_info_DrivingMapInfo_message_Sys_5fDataUploadProto_5fplanning_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 8, InitDefaultsscc_info_DrivingMapInfo_message_Sys_5fDataUploadProto_5fplanning_2eproto}, {
      &scc_info_MsgHead_message_Sys_5fDataUploadProto_5fplanning_2eproto.base,
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_PathPln_Display_Data_message_Sys_5fDataUploadProto_5fplanning_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsscc_info_PathPln_Display_Data_message_Sys_5fDataUploadProto_5fplanning_2eproto}, {
      &scc_info_DrivingMapInfo_message_Sys_5fDataUploadProto_5fplanning_2eproto.base,}};
...
static void InitDefaultsscc_info_SpdPln_Display_Data_message_Sys_5fDataUploadProto_5fplanning_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::phoenix::ad_data_upload::_SpdPln_Display_Data_message_default_instance_;
    new (ptr) ::phoenix::ad_data_upload::SpdPln_Display_Data_message();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::phoenix::ad_data_upload::SpdPln_Display_Data_message::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<4> scc_info_SpdPln_Display_Data_message_Sys_5fDataUploadProto_5fplanning_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 4, InitDefaultsscc_info_SpdPln_Display_Data_message_Sys_5fDataUploadProto_5fplanning_2eproto}, {
...
void TarTrj_message::SerializeWithCachedSizes(
  ...
  // sint32 timestamp = 1;
  if (this->timestamp() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteSInt32(1, this->timestamp(), output);
  }
...
void SpdPln_Display_Data_message::InitAsDefaultInstance() {
  ::phoenix::ad_data_upload::_SpdPln_Display_Data_message_default_instance_._instance.get_mutable()->action_planning_result_ = const_cast< ::phoenix::ad_data_upload::ActionPlanningResult_message*>(
      ::phoenix::ad_data_upload::ActionPlanningResult_message::internal_default_instance());
  ::phoenix::ad_data_upload::_SpdPln_Display_Data_message_default_instance_._instance.get_mutable()->trajectory_planning_result_ = const_cast< ::phoenix::ad_data_upload::TrajectoryPlanningResult_message*>(
      ::phoenix::ad_data_upload::TrajectoryPlanningResult_message::internal_default_instance());
  ::phoenix::ad_data_upload::_SpdPln_Display_Data_message_default_instance_._instance.get_mutable()->planning_result_ = const_cast< ::phoenix::ad_data_upload::PlanningResult_message*>(
      ::phoenix::ad_data_upload::PlanningResult_message::internal_default_instance());
  ::phoenix::ad_data_upload::_SpdPln_Display_Data_message_default_instance_._instance.get_mutable()->velocity_planning_result_ = const_cast< ::phoenix::ad_data_upload::VelocityPlanningResult_message*>(
      ::phoenix::ad_data_upload::VelocityPlanningResult_message::internal_default_instance());
}
class SpdPln_Display_Data_message::_Internal {
 public:
  static const ::phoenix::ad_data_upload::ActionPlanningResult_message& action_planning_result(const SpdPln_Display_Data_message* msg);
  static const ::phoenix::ad_data_upload::TrajectoryPlanningResult_message& trajectory_planning_result(const SpdPln_Display_Data_message* msg);
  static const ::phoenix::ad_data_upload::PlanningResult_message& planning_result(const SpdPln_Display_Data_message* msg);
  static const ::phoenix::ad_data_upload::VelocityPlanningResult_message& velocity_planning_result(const SpdPln_Display_Data_message* msg);
};

const ::phoenix::ad_data_upload::ActionPlanningResult_message&
SpdPln_Display_Data_message::_Internal::action_planning_result(const SpdPln_Display_Data_message* msg) {
  return *msg->action_planning_result_;
}
const ::phoenix::ad_data_upload::TrajectoryPlanningResult_message&
SpdPln_Display_Data_message::_Internal::trajectory_planning_result(const SpdPln_Display_Data_message* msg) {
  return *msg->trajectory_planning_result_;
}
const ::phoenix::ad_data_upload::PlanningResult_message&
SpdPln_Display_Data_message::_Internal::planning_result(const SpdPln_Display_Data_message* msg) {
  return *msg->planning_result_;
}
const ::phoenix::ad_data_upload::VelocityPlanningResult_message&
SpdPln_Display_Data_message::_Internal::velocity_planning_result(const SpdPln_Display_Data_message* msg) {
  return *msg->velocity_planning_result_;
}
SpdPln_Display_Data_message::SpdPln_Display_Data_message()
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:phoenix.ad_data_upload.SpdPln_Display_Data_message)
}
SpdPln_Display_Data_message::SpdPln_Display_Data_message(const SpdPln_Display_Data_message& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(),
      _internal_metadata_(nullptr) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ...
  // @@protoc_insertion_point(copy_constructor:phoenix.ad_data_upload.SpdPln_Display_Data_message)
}

void SpdPln_Display_Data_message::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_SpdPln_Display_Data_message_Sys_5fDataUploadProto_5fplanning_2eproto.base);
  ::memset(&action_planning_result_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&velocity_planning_result_) -
      reinterpret_cast<char*>(&action_planning_result_)) + sizeof(velocity_planning_result_));
}

SpdPln_Display_Data_message::~SpdPln_Display_Data_message() {
  // @@protoc_insertion_point(destructor:phoenix.ad_data_upload.SpdPln_Display_Data_message)
  SharedDtor();
}

void SpdPln_Display_Data_message::SharedDtor() {
...
void SpdPln_Display_Data_message::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const SpdPln_Display_Data_message& SpdPln_Display_Data_message::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_SpdPln_Display_Data_message_Sys_5fDataUploadProto_5fplanning_2eproto.base);
  return *internal_default_instance();
}


void SpdPln_Display_Data_message::Clear() {
// @@protoc_insertion_point(message_clear_start:phoenix.ad_data_upload.SpdPln_Display_Data_message)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
#if GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
const char* SpdPln_Display_Data_message::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
#else  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
bool SpdPln_Display_Data_message::MergePartialFromCodedStream(
    ::PROTOBUF_NAMESPACE_ID::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ::PROTOBUF_NAMESPACE_ID::uint32 tag;
  ::PROTOBUF_NAMESPACE_ID::internal::LiteUnknownFieldSetter unknown_fields_setter(
  ...
  ::PROTOBUF_NAMESPACE_ID::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_output, false);
  // @@protoc_insertion_point(parse_start:phoenix.ad_data_upload.SpdPln_Display_Data_message)
  for (;;) {
    ::std::pair<::PROTOBUF_NAMESPACE_ID::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:phoenix.ad_data_upload.SpdPln_Display_Data_message)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:phoenix.ad_data_upload.SpdPln_Display_Data_message)
  return false;
#undef DO_
}
#endif  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER

void SpdPln_Display_Data_message::SerializeWithCachedSizes(
    ::PROTOBUF_NAMESPACE_ID::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:phoenix.ad_data_upload.SpdPln_Display_Data_message)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (this->has_trajectory_planning_result()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteMessage(
      2, _Internal::trajectory_planning_result(this), output);
  }

  // .phoenix.ad_data_upload.PlanningResult_message planning_result = 3;
  if (this->has_planning_result()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteMessage(
      3, _Internal::planning_result(this), output);
  }

  // .phoenix.ad_data_upload.VelocityPlanningResult_message velocity_planning_result = 4;
  if (this->has_velocity_planning_result()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteMessage(
      4, _Internal::velocity_planning_result(this), output);
  }

  output->WriteRaw(_internal_metadata_.unknown_fields().data(),
                   static_cast<int>(_internal_metadata_.unknown_fields().size()));
  // @@protoc_insertion_point(serialize_end:phoenix.ad_data_upload.SpdPln_Display_Data_message)
}

size_t SpdPln_Display_Data_message::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:phoenix.ad_data_upload.SpdPln_Display_Data_message)
  size_t total_size = 0;
...
void SpdPln_Display_Data_message::CheckTypeAndMergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) {
  MergeFrom(*::PROTOBUF_NAMESPACE_ID::internal::DownCast<const SpdPln_Display_Data_message*>(
      &from));
}

void SpdPln_Display_Data_message::MergeFrom(const SpdPln_Display_Data_message& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:phoenix.ad_data_upload.SpdPln_Display_Data_message)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void SpdPln_Display_Data_message::CopyFrom(const SpdPln_Display_Data_message& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:phoenix.ad_data_upload.SpdPln_Display_Data_message)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool SpdPln_Display_Data_message::IsInitialized() const {
  return true;
}

void SpdPln_Display_Data_message::InternalSwap(SpdPln_Display_Data_message* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
...
std::string SpdPln_Display_Data_message::GetTypeName() const {
...
void TrajectoryPoint_message::InitAsDefaultInstance() {
  ::phoenix::ad_data_upload::_TrajectoryPoint_message_default_instance_._instance.get_mutable()->path_point_ = const_cast< ::phoenix::ad_data_upload::PathPoint_message*>(
      ::phoenix::ad_data_upload::PathPoint_message::internal_default_instance());
}
class TrajectoryPoint_message::_Internal {
 public:
  static const ::phoenix::ad_data_upload::PathPoint_message& path_point(const TrajectoryPoint_message* msg);
};

const ::phoenix::ad_data_upload::PathPoint_message&
TrajectoryPoint_message::_Internal::path_point(const TrajectoryPoint_message* msg) {
...
TrajectoryPoint_message::TrajectoryPoint_message(const TrajectoryPoint_message& from)
  ...
  if (from.has_path_point()) {
    path_point_ = new ::phoenix::ad_data_upload::PathPoint_message(*from.path_point_);
  } else {
    path_point_ = nullptr;
  }
  ::memcpy(&v_, &from.v_,
...
// @@protoc_insertion_point(class_specific_merge_from_start:phoenix.ad_data_upload.TrajectoryPoint_message)
  ...
  if (from.has_path_point()) {
    mutable_path_point()->::phoenix::ad_data_upload::PathPoint_message::MergeFrom(from.path_point());
  }
...
void DrivingMapInfo_message::InitAsDefaultInstance() {
  ::phoenix::ad_data_upload::_DrivingMapInfo_message_default_instance_._instance.get_mutable()->msg_head_ = const_cast< ::phoenix::ad_data_upload::MsgHead_message*>(
      ::phoenix::ad_data_upload::MsgHead_message::internal_default_instance());
  ::phoenix::ad_data_upload::_DrivingMapInfo_message_default_instance_._instance.get_mutable()->nearest_point_to_veh_on_lane_ = const_cast< ::phoenix::ad_data_upload::PathPoint_message*>(
      ::phoenix::ad_data_upload::PathPoint_message::internal_default_instance());
  ::phoenix::ad_data_upload::_DrivingMapInfo_message_default_instance_._instance.get_mutable()->map_ = const_cast< ::phoenix::ad_data_upload::MapInfo_message*>(
      ::phoenix::ad_data_upload::MapInfo_message::internal_default_instance());
  ::phoenix::ad_data_upload::_DrivingMapInfo_message_default_instance_._instance.get_mutable()->following_target_ = const_cast< ::phoenix::ad_data_upload::FollowingTarget_message*>(
      ::phoenix::ad_data_upload::FollowingTarget_message::internal_default_instance());
}
class DrivingMapInfo_message::_Internal {
 public:
  static const ::phoenix::ad_data_upload::MsgHead_message& msg_head(const DrivingMapInfo_message* msg);
  static const ::phoenix::ad_data_upload::PathPoint_message& nearest_point_to_veh_on_lane(const DrivingMapInfo_message* msg);
  static const ::phoenix::ad_data_upload::MapInfo_message& map(const DrivingMapInfo_message* msg);
  static const ::phoenix::ad_data_upload::FollowingTarget_message& following_target(const DrivingMapInfo_message* msg);
};

const ::phoenix::ad_data_upload::MsgHead_message&
DrivingMapInfo_message::_Internal::msg_head(const DrivingMapInfo_message* msg) {
  return *msg->msg_head_;
}
const ::phoenix::ad_data_upload::PathPoint_message&
DrivingMapInfo_message::_Internal::nearest_point_to_veh_on_lane(const DrivingMapInfo_message* msg) {
  return *msg->nearest_point_to_veh_on_lane_;
}
const ::phoenix::ad_data_upload::MapInfo_message&
DrivingMapInfo_message::_Internal::map(const DrivingMapInfo_message* msg) {
  return *msg->map_;
}
const ::phoenix::ad_data_upload::FollowingTarget_message&
DrivingMapInfo_message::_Internal::following_target(const DrivingMapInfo_message* msg) {
  return *msg->following_target_;
}
DrivingMapInfo_message::DrivingMapInfo_message()
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:phoenix.ad_data_upload.DrivingMapInfo_message)
}
DrivingMapInfo_message::DrivingMapInfo_message(const DrivingMapInfo_message& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(),
      _internal_metadata_(nullptr),
  ...
  // @@protoc_insertion_point(copy_constructor:phoenix.ad_data_upload.DrivingMapInfo_message)
}

void DrivingMapInfo_message::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_DrivingMapInfo_message_Sys_5fDataUploadProto_5fplanning_2eproto.base);
  ::memset(&msg_head_, 0, static_cast<size_t>(
...
DrivingMapInfo_message::~DrivingMapInfo_message() {
  // @@protoc_insertion_point(destructor:phoenix.ad_data_upload.DrivingMapInfo_message)
  SharedDtor();
}

void DrivingMapInfo_message::SharedDtor() {
  if (this != internal_default_instance()) delete msg_head_;
...
void DrivingMapInfo_message::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const DrivingMapInfo_message& DrivingMapInfo_message::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_DrivingMapInfo_message_Sys_5fDataUploadProto_5fplanning_2eproto.base);
  return *internal_default_instance();
}


void DrivingMapInfo_message::Clear() {
// @@protoc_insertion_point(message_clear_start:phoenix.ad_data_upload.DrivingMapInfo_message)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
#if GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
const char* DrivingMapInfo_message::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
#else  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
bool DrivingMapInfo_message::MergePartialFromCodedStream(
    ::PROTOBUF_NAMESPACE_ID::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ::PROTOBUF_NAMESPACE_ID::uint32 tag;
  ::PROTOBUF_NAMESPACE_ID::internal::LiteUnknownFieldSetter unknown_fields_setter(
  ...
  ::PROTOBUF_NAMESPACE_ID::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_output, false);
  // @@protoc_insertion_point(parse_start:phoenix.ad_data_upload.DrivingMapInfo_message)
  for (;;) {
    ::std::pair<::PROTOBUF_NAMESPACE_ID::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:phoenix.ad_data_upload.DrivingMapInfo_message)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:phoenix.ad_data_upload.DrivingMapInfo_message)
  return false;
#undef DO_
}
#endif  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER

void DrivingMapInfo_message::SerializeWithCachedSizes(
    ::PROTOBUF_NAMESPACE_ID::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:phoenix.ad_data_upload.DrivingMapInfo_message)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (this->current_reference_line_index() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteSInt32(4, this->current_reference_line_index(), output);
  }

  // uint32 reference_lines_count = 5;
  if (this->reference_lines_count() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32(5, this->reference_lines_count(), output);
  }
  ...
  if (this->road_boundary_count() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32(7, this->road_boundary_count(), output);
  }
  ...
  if (this->obstacle_list_count() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32(9, this->obstacle_list_count(), output);
  }
  ...
  if (this->risky_obj_list_count() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32(11, this->risky_obj_list_count(), output);
  }
  ...
  if (this->uncertain_list_count() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32(13, this->uncertain_list_count(), output);
  }
  ...
  if (this->has_following_target()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteMessage(
      15, _Internal::following_target(this), output);
  }

  output->WriteRaw(_internal_metadata_.unknown_fields().data(),
                   static_cast<int>(_internal_metadata_.unknown_fields().size()));
  // @@protoc_insertion_point(serialize_end:phoenix.ad_data_upload.DrivingMapInfo_message)
}

size_t DrivingMapInfo_message::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:phoenix.ad_data_upload.DrivingMapInfo_message)
  size_t total_size = 0;
...
void DrivingMapInfo_message::CheckTypeAndMergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) {
  MergeFrom(*::PROTOBUF_NAMESPACE_ID::internal::DownCast<const DrivingMapInfo_message*>(
      &from));
}

void DrivingMapInfo_message::MergeFrom(const DrivingMapInfo_message& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:phoenix.ad_data_upload.DrivingMapInfo_message)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void DrivingMapInfo_message::CopyFrom(const DrivingMapInfo_message& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:phoenix.ad_data_upload.DrivingMapInfo_message)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool DrivingMapInfo_message::IsInitialized() const {
  return true;
}

void DrivingMapInfo_message::InternalSwap(DrivingMapInfo_message* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
...
std::string DrivingMapInfo_message::GetTypeName() const {
...
void PathPln_Display_Data_message::InitAsDefaultInstance() {
  ::phoenix::ad_data_upload::_PathPln_Display_Data_message_default_instance_._instance.get_mutable()->driving_map_info_ = const_cast< ::phoenix::ad_data_upload::DrivingMapInfo_message*>(
      ::phoenix::ad_data_upload::DrivingMapInfo_message::internal_default_instance());
}
class PathPln_Display_Data_message::_Internal {
 public:
  static const ::phoenix::ad_data_upload::DrivingMapInfo_message& driving_map_info(const PathPln_Display_Data_message* msg);
};

const ::phoenix::ad_data_upload::DrivingMapInfo_message&
PathPln_Display_Data_message::_Internal::driving_map_info(const PathPln_Display_Data_message* msg) {
  return *msg->driving_map_info_;
}
...
PathPln_Display_Data_message::PathPln_Display_Data_message(const PathPln_Display_Data_message& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(),
      _internal_metadata_(nullptr) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  if (from.has_driving_map_info()) {
    driving_map_info_ = new ::phoenix::ad_data_upload::DrivingMapInfo_message(*from.driving_map_info_);
  } else {
...
void PathPln_Display_Data_message::SharedDtor() {
  if (this != internal_default_instance()) delete driving_map_info_;
}
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ctx->ParseMessage(mutable_driving_map_info(), ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
  ...
  for (;;) {
    ...
    switch (::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (10 & 0xFF)) {
          DO_(::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadMessage(
               input, mutable_driving_map_info()));
        } else {
          goto handle_unusual;
        }
        break;
...
void PathPln_Display_Data_message::SerializeWithCachedSizes(
  ...
  // .phoenix.ad_data_upload.DrivingMapInfo_message driving_map_info = 1;
  if (this->has_driving_map_info()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteMessage(
      1, _Internal::driving_map_info(this), output);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:phoenix.ad_data_upload.PathPln_Display_Data_message)
  ...
  if (from.has_driving_map_info()) {
    mutable_driving_map_info()->::phoenix::ad_data_upload::DrivingMapInfo_message::MergeFrom(from.driving_map_info());
  }
}
...
void PathPln_Display_Data_message::InternalSwap(PathPln_Display_Data_message* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
  swap(driving_map_info_, other->driving_map_info_);
}
...
template<> PROTOBUF_NOINLINE ::phoenix::ad_data_upload::SpdPln_Display_Data_message* Arena::CreateMaybeMessage< ::phoenix::ad_data_upload::SpdPln_Display_Data_message >(Arena* arena) {
  return Arena::CreateInternal< ::phoenix::ad_data_upload::SpdPln_Display_Data_message >(arena);
}
...
template<> PROTOBUF_NOINLINE ::phoenix::ad_data_upload::DrivingMapInfo_message* Arena::CreateMaybeMessage< ::phoenix::ad_data_upload::DrivingMapInfo_message >(Arena* arena) {
  return Arena::CreateInternal< ::phoenix::ad_data_upload::DrivingMapInfo_message >(arena);
}
