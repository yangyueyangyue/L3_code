...
class DrivingMapInfo_message;
class DrivingMapInfo_messageDefaultTypeInternal;
extern DrivingMapInfo_messageDefaultTypeInternal _DrivingMapInfo_message_default_instance_;
...
class SpdPln_Display_Data_message;
class SpdPln_Display_Data_messageDefaultTypeInternal;
extern SpdPln_Display_Data_messageDefaultTypeInternal _SpdPln_Display_Data_message_default_instance_;
...
template<> ::phoenix::ad_data_upload::DrivingMapInfo_message* Arena::CreateMaybeMessage<::phoenix::ad_data_upload::DrivingMapInfo_message>(Arena*);
...
template<> ::phoenix::ad_data_upload::SpdPln_Display_Data_message* Arena::CreateMaybeMessage<::phoenix::ad_data_upload::SpdPln_Display_Data_message>(Arena*);
...
class SpdPln_Display_Data_message :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:phoenix.ad_data_upload.SpdPln_Display_Data_message) */ {
 public:
  SpdPln_Display_Data_message();
  virtual ~SpdPln_Display_Data_message();

  SpdPln_Display_Data_message(const SpdPln_Display_Data_message& from);
  SpdPln_Display_Data_message(SpdPln_Display_Data_message&& from) noexcept
    : SpdPln_Display_Data_message() {
    *this = ::std::move(from);
  }

  inline SpdPln_Display_Data_message& operator=(const SpdPln_Display_Data_message& from) {
    CopyFrom(from);
    return *this;
  }
  inline SpdPln_Display_Data_message& operator=(SpdPln_Display_Data_message&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const SpdPln_Display_Data_message& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const SpdPln_Display_Data_message* internal_default_instance() {
    return reinterpret_cast<const SpdPln_Display_Data_message*>(
               &_SpdPln_Display_Data_message_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    19;

  friend void swap(SpdPln_Display_Data_message& a, SpdPln_Display_Data_message& b) {
    a.Swap(&b);
  }
  inline void Swap(SpdPln_Display_Data_message* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline SpdPln_Display_Data_message* New() const final {
    return CreateMaybeMessage<SpdPln_Display_Data_message>(nullptr);
  }

  SpdPln_Display_Data_message* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<SpdPln_Display_Data_message>(arena);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)
    final;
  void CopyFrom(const SpdPln_Display_Data_message& from);
  void MergeFrom(const SpdPln_Display_Data_message& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(SpdPln_Display_Data_message* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "phoenix.ad_data_upload.SpdPln_Display_Data_message";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  enum : int {
    ...
    kTrajectoryPlanningResultFieldNumber = 2,
    kPlanningResultFieldNumber = 3,
    kVelocityPlanningResultFieldNumber = 4,
  };
  ...
  // .phoenix.ad_data_upload.TrajectoryPlanningResult_message trajectory_planning_result = 2;
  ...
  // .phoenix.ad_data_upload.PlanningResult_message planning_result = 3;
  ...
  // .phoenix.ad_data_upload.VelocityPlanningResult_message velocity_planning_result = 4;
  ...
  // @@protoc_insertion_point(class_scope:phoenix.ad_data_upload.SpdPln_Display_Data_message)
 private:
  class _Internal;
...
class TrajectoryPoint_message :
 ...
 public:
  ...
  // .phoenix.ad_data_upload.PathPoint_message path_point = 1;
  bool has_path_point() const;
  void clear_path_point();
  const ::phoenix::ad_data_upload::PathPoint_message& path_point() const;
  ::phoenix::ad_data_upload::PathPoint_message* release_path_point();
  ::phoenix::ad_data_upload::PathPoint_message* mutable_path_point();
  void set_allocated_path_point(::phoenix::ad_data_upload::PathPoint_message* path_point);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArenaLite _internal_metadata_;
  ::phoenix::ad_data_upload::PathPoint_message* path_point_;
  float v_;
  float a_;
  float yaw_rate_;
...
class ObstacleInfo_message :
 ...
 public:
  ...
  // repeated .phoenix.ad_data_upload.TrajectoryPoint_message pred_trajectory = 12;
...
class DrivingMapInfo_message :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:phoenix.ad_data_upload.DrivingMapInfo_message) */ {
 public:
  DrivingMapInfo_message();
  virtual ~DrivingMapInfo_message();

  DrivingMapInfo_message(const DrivingMapInfo_message& from);
  DrivingMapInfo_message(DrivingMapInfo_message&& from) noexcept
    : DrivingMapInfo_message() {
    *this = ::std::move(from);
  }

  inline DrivingMapInfo_message& operator=(const DrivingMapInfo_message& from) {
    CopyFrom(from);
    return *this;
  }
  inline DrivingMapInfo_message& operator=(DrivingMapInfo_message&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const DrivingMapInfo_message& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const DrivingMapInfo_message* internal_default_instance() {
    return reinterpret_cast<const DrivingMapInfo_message*>(
               &_DrivingMapInfo_message_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    33;

  friend void swap(DrivingMapInfo_message& a, DrivingMapInfo_message& b) {
    a.Swap(&b);
  }
  inline void Swap(DrivingMapInfo_message* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline DrivingMapInfo_message* New() const final {
    return CreateMaybeMessage<DrivingMapInfo_message>(nullptr);
  }

  DrivingMapInfo_message* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<DrivingMapInfo_message>(arena);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)
    final;
  void CopyFrom(const DrivingMapInfo_message& from);
  void MergeFrom(const DrivingMapInfo_message& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(DrivingMapInfo_message* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "phoenix.ad_data_upload.DrivingMapInfo_message";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  enum : int {
    kReferenceLinesFieldNumber = 6,
    kRoadBoundaryFieldNumber = 8,
    kObstacleListFieldNumber = 10,
    kRiskyObjListFieldNumber = 12,
    kUncertainListFieldNumber = 14,
    kMsgHeadFieldNumber = 1,
    kNearestPointToVehOnLaneFieldNumber = 2,
    kMapFieldNumber = 3,
    kFollowingTargetFieldNumber = 15,
    kCurrentReferenceLineIndexFieldNumber = 4,
    kReferenceLinesCountFieldNumber = 5,
    kRoadBoundaryCountFieldNumber = 7,
    kObstacleListCountFieldNumber = 9,
    kRiskyObjListCountFieldNumber = 11,
    kUncertainListCountFieldNumber = 13,
  };
  // repeated .phoenix.ad_data_upload.ReferenceLineInfo_message reference_lines = 6;
  ...
  // repeated .phoenix.ad_data_upload.RoadBoundary_message road_boundary = 8;
  ...
  // repeated .phoenix.ad_data_upload.ObstacleInfo_message obstacle_list = 10;
  ...
  // repeated .phoenix.ad_data_upload.ObjInfo_message risky_obj_list = 12;
  ...
  // repeated .phoenix.ad_data_upload.ObjInfo_message uncertain_list = 14;
  ...
  // .phoenix.ad_data_upload.MapInfo_message map = 3;
  bool has_map() const;
  void clear_map();
  ...
  // .phoenix.ad_data_upload.FollowingTarget_message following_target = 15;
  ...
  // @@protoc_insertion_point(class_scope:phoenix.ad_data_upload.DrivingMapInfo_message)
 private:
  class _Internal;
...
class PathPln_Display_Data_message :
 ...
 public:
  ...
  enum : int {
    kDrivingMapInfoFieldNumber = 1,
  };
  // .phoenix.ad_data_upload.DrivingMapInfo_message driving_map_info = 1;
  bool has_driving_map_info() const;
  void clear_driving_map_info();
  const ::phoenix::ad_data_upload::DrivingMapInfo_message& driving_map_info() const;
  ::phoenix::ad_data_upload::DrivingMapInfo_message* release_driving_map_info();
  ::phoenix::ad_data_upload::DrivingMapInfo_message* mutable_driving_map_info();
  void set_allocated_driving_map_info(::phoenix::ad_data_upload::DrivingMapInfo_message* driving_map_info);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArenaLite _internal_metadata_;
  ::phoenix::ad_data_upload::DrivingMapInfo_message* driving_map_info_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_Sys_5fDataUploadProto_5fplanning_2eproto;
};
// ===================================================================
...
inline ::PROTOBUF_NAMESPACE_ID::int32 MsgHead_message::timestamp() const {
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.MsgHead_message.timestamp)
  return timestamp_;
}
inline void MsgHead_message::set_timestamp(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 TarTrj_message::timestamp() const {
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.TarTrj_message.timestamp)
  return timestamp_;
}
inline void TarTrj_message::set_timestamp(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 TarTrj_message::trj_direction() const {
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.TarTrj_message.trj_direction)
  return trj_direction_;
}
inline void TarTrj_message::set_trj_direction(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
// .phoenix.ad_data_upload.ActionPlanningResult_message action_planning_result = 1;
inline bool SpdPln_Display_Data_message::has_action_planning_result() const {
  return this != internal_default_instance() && action_planning_result_ != nullptr;
}
inline void SpdPln_Display_Data_message::clear_action_planning_result() {
...
inline const ::phoenix::ad_data_upload::ActionPlanningResult_message& SpdPln_Display_Data_message::action_planning_result() const {
  const ::phoenix::ad_data_upload::ActionPlanningResult_message* p = action_planning_result_;
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.SpdPln_Display_Data_message.action_planning_result)
...
inline ::phoenix::ad_data_upload::ActionPlanningResult_message* SpdPln_Display_Data_message::release_action_planning_result() {
  // @@protoc_insertion_point(field_release:phoenix.ad_data_upload.SpdPln_Display_Data_message.action_planning_result)
  
  ::phoenix::ad_data_upload::ActionPlanningResult_message* temp = action_planning_result_;
  action_planning_result_ = nullptr;
  return temp;
}
inline ::phoenix::ad_data_upload::ActionPlanningResult_message* SpdPln_Display_Data_message::mutable_action_planning_result() {
  ...
  // @@protoc_insertion_point(field_mutable:phoenix.ad_data_upload.SpdPln_Display_Data_message.action_planning_result)
  return action_planning_result_;
}
inline void SpdPln_Display_Data_message::set_allocated_action_planning_result(::phoenix::ad_data_upload::ActionPlanningResult_message* action_planning_result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete action_planning_result_;
  }
  ...
  // @@protoc_insertion_point(field_set_allocated:phoenix.ad_data_upload.SpdPln_Display_Data_message.action_planning_result)
}

// .phoenix.ad_data_upload.TrajectoryPlanningResult_message trajectory_planning_result = 2;
inline bool SpdPln_Display_Data_message::has_trajectory_planning_result() const {
  return this != internal_default_instance() && trajectory_planning_result_ != nullptr;
}
inline void SpdPln_Display_Data_message::clear_trajectory_planning_result() {
...
inline const ::phoenix::ad_data_upload::TrajectoryPlanningResult_message& SpdPln_Display_Data_message::trajectory_planning_result() const {
  const ::phoenix::ad_data_upload::TrajectoryPlanningResult_message* p = trajectory_planning_result_;
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.SpdPln_Display_Data_message.trajectory_planning_result)
...
inline ::phoenix::ad_data_upload::TrajectoryPlanningResult_message* SpdPln_Display_Data_message::release_trajectory_planning_result() {
  // @@protoc_insertion_point(field_release:phoenix.ad_data_upload.SpdPln_Display_Data_message.trajectory_planning_result)
  
  ::phoenix::ad_data_upload::TrajectoryPlanningResult_message* temp = trajectory_planning_result_;
  trajectory_planning_result_ = nullptr;
  return temp;
}
inline ::phoenix::ad_data_upload::TrajectoryPlanningResult_message* SpdPln_Display_Data_message::mutable_trajectory_planning_result() {
  ...
  // @@protoc_insertion_point(field_mutable:phoenix.ad_data_upload.SpdPln_Display_Data_message.trajectory_planning_result)
  return trajectory_planning_result_;
}
inline void SpdPln_Display_Data_message::set_allocated_trajectory_planning_result(::phoenix::ad_data_upload::TrajectoryPlanningResult_message* trajectory_planning_result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete trajectory_planning_result_;
  }
  ...
  // @@protoc_insertion_point(field_set_allocated:phoenix.ad_data_upload.SpdPln_Display_Data_message.trajectory_planning_result)
}

// .phoenix.ad_data_upload.PlanningResult_message planning_result = 3;
inline bool SpdPln_Display_Data_message::has_planning_result() const {
  return this != internal_default_instance() && planning_result_ != nullptr;
}
inline void SpdPln_Display_Data_message::clear_planning_result() {
  if (GetArenaNoVirtual() == nullptr && planning_result_ != nullptr) {
    delete planning_result_;
  }
  planning_result_ = nullptr;
}
inline const ::phoenix::ad_data_upload::PlanningResult_message& SpdPln_Display_Data_message::planning_result() const {
  const ::phoenix::ad_data_upload::PlanningResult_message* p = planning_result_;
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.SpdPln_Display_Data_message.planning_result)
...
inline ::phoenix::ad_data_upload::PlanningResult_message* SpdPln_Display_Data_message::release_planning_result() {
  // @@protoc_insertion_point(field_release:phoenix.ad_data_upload.SpdPln_Display_Data_message.planning_result)
  
  ::phoenix::ad_data_upload::PlanningResult_message* temp = planning_result_;
  planning_result_ = nullptr;
  return temp;
}
inline ::phoenix::ad_data_upload::PlanningResult_message* SpdPln_Display_Data_message::mutable_planning_result() {
  
  if (planning_result_ == nullptr) {
    auto* p = CreateMaybeMessage<::phoenix::ad_data_upload::PlanningResult_message>(GetArenaNoVirtual());
    planning_result_ = p;
  }
  // @@protoc_insertion_point(field_mutable:phoenix.ad_data_upload.SpdPln_Display_Data_message.planning_result)
  return planning_result_;
}
inline void SpdPln_Display_Data_message::set_allocated_planning_result(::phoenix::ad_data_upload::PlanningResult_message* planning_result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete planning_result_;
  }
  ...
  // @@protoc_insertion_point(field_set_allocated:phoenix.ad_data_upload.SpdPln_Display_Data_message.planning_result)
}

// .phoenix.ad_data_upload.VelocityPlanningResult_message velocity_planning_result = 4;
inline bool SpdPln_Display_Data_message::has_velocity_planning_result() const {
  return this != internal_default_instance() && velocity_planning_result_ != nullptr;
}
inline void SpdPln_Display_Data_message::clear_velocity_planning_result() {
...
inline const ::phoenix::ad_data_upload::VelocityPlanningResult_message& SpdPln_Display_Data_message::velocity_planning_result() const {
  const ::phoenix::ad_data_upload::VelocityPlanningResult_message* p = velocity_planning_result_;
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.SpdPln_Display_Data_message.velocity_planning_result)
...
inline ::phoenix::ad_data_upload::VelocityPlanningResult_message* SpdPln_Display_Data_message::release_velocity_planning_result() {
  // @@protoc_insertion_point(field_release:phoenix.ad_data_upload.SpdPln_Display_Data_message.velocity_planning_result)
  
  ::phoenix::ad_data_upload::VelocityPlanningResult_message* temp = velocity_planning_result_;
  velocity_planning_result_ = nullptr;
  return temp;
}
inline ::phoenix::ad_data_upload::VelocityPlanningResult_message* SpdPln_Display_Data_message::mutable_velocity_planning_result() {
  ...
  // @@protoc_insertion_point(field_mutable:phoenix.ad_data_upload.SpdPln_Display_Data_message.velocity_planning_result)
  return velocity_planning_result_;
}
inline void SpdPln_Display_Data_message::set_allocated_velocity_planning_result(::phoenix::ad_data_upload::VelocityPlanningResult_message* velocity_planning_result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete velocity_planning_result_;
  }
  ...
  // @@protoc_insertion_point(field_set_allocated:phoenix.ad_data_upload.SpdPln_Display_Data_message.velocity_planning_result)
}
...
// .phoenix.ad_data_upload.PathPoint_message path_point = 1;
inline bool TrajectoryPoint_message::has_path_point() const {
  return this != internal_default_instance() && path_point_ != nullptr;
}
inline void TrajectoryPoint_message::clear_path_point() {
  if (GetArenaNoVirtual() == nullptr && path_point_ != nullptr) {
    delete path_point_;
  }
  path_point_ = nullptr;
}
inline const ::phoenix::ad_data_upload::PathPoint_message& TrajectoryPoint_message::path_point() const {
  const ::phoenix::ad_data_upload::PathPoint_message* p = path_point_;
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.TrajectoryPoint_message.path_point)
  return p != nullptr ? *p : *reinterpret_cast<const ::phoenix::ad_data_upload::PathPoint_message*>(
      &::phoenix::ad_data_upload::_PathPoint_message_default_instance_);
}
inline ::phoenix::ad_data_upload::PathPoint_message* TrajectoryPoint_message::release_path_point() {
  // @@protoc_insertion_point(field_release:phoenix.ad_data_upload.TrajectoryPoint_message.path_point)
  
  ::phoenix::ad_data_upload::PathPoint_message* temp = path_point_;
  path_point_ = nullptr;
  return temp;
}
inline ::phoenix::ad_data_upload::PathPoint_message* TrajectoryPoint_message::mutable_path_point() {
  
  if (path_point_ == nullptr) {
    auto* p = CreateMaybeMessage<::phoenix::ad_data_upload::PathPoint_message>(GetArenaNoVirtual());
    path_point_ = p;
  }
  // @@protoc_insertion_point(field_mutable:phoenix.ad_data_upload.TrajectoryPoint_message.path_point)
  return path_point_;
}
inline void TrajectoryPoint_message::set_allocated_path_point(::phoenix::ad_data_upload::PathPoint_message* path_point) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete path_point_;
  }
  ...
  // @@protoc_insertion_point(field_set_allocated:phoenix.ad_data_upload.TrajectoryPoint_message.path_point)
}
...
// .phoenix.ad_data_upload.MsgHead_message msg_head = 1;
inline bool DrivingMapInfo_message::has_msg_head() const {
  return this != internal_default_instance() && msg_head_ != nullptr;
}
inline void DrivingMapInfo_message::clear_msg_head() {
  if (GetArenaNoVirtual() == nullptr && msg_head_ != nullptr) {
    delete msg_head_;
  }
  msg_head_ = nullptr;
}
inline const ::phoenix::ad_data_upload::MsgHead_message& DrivingMapInfo_message::msg_head() const {
  const ::phoenix::ad_data_upload::MsgHead_message* p = msg_head_;
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.DrivingMapInfo_message.msg_head)
  return p != nullptr ? *p : *reinterpret_cast<const ::phoenix::ad_data_upload::MsgHead_message*>(
      &::phoenix::ad_data_upload::_MsgHead_message_default_instance_);
}
inline ::phoenix::ad_data_upload::MsgHead_message* DrivingMapInfo_message::release_msg_head() {
  // @@protoc_insertion_point(field_release:phoenix.ad_data_upload.DrivingMapInfo_message.msg_head)
  
  ::phoenix::ad_data_upload::MsgHead_message* temp = msg_head_;
  msg_head_ = nullptr;
  return temp;
}
inline ::phoenix::ad_data_upload::MsgHead_message* DrivingMapInfo_message::mutable_msg_head() {
  
  if (msg_head_ == nullptr) {
    auto* p = CreateMaybeMessage<::phoenix::ad_data_upload::MsgHead_message>(GetArenaNoVirtual());
    msg_head_ = p;
  }
  // @@protoc_insertion_point(field_mutable:phoenix.ad_data_upload.DrivingMapInfo_message.msg_head)
  return msg_head_;
}
inline void DrivingMapInfo_message::set_allocated_msg_head(::phoenix::ad_data_upload::MsgHead_message* msg_head) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete msg_head_;
  }
  ...
  msg_head_ = msg_head;
  // @@protoc_insertion_point(field_set_allocated:phoenix.ad_data_upload.DrivingMapInfo_message.msg_head)
}

// .phoenix.ad_data_upload.PathPoint_message nearest_point_to_veh_on_lane = 2;
inline bool DrivingMapInfo_message::has_nearest_point_to_veh_on_lane() const {
  return this != internal_default_instance() && nearest_point_to_veh_on_lane_ != nullptr;
}
inline void DrivingMapInfo_message::clear_nearest_point_to_veh_on_lane() {
...
inline const ::phoenix::ad_data_upload::PathPoint_message& DrivingMapInfo_message::nearest_point_to_veh_on_lane() const {
  const ::phoenix::ad_data_upload::PathPoint_message* p = nearest_point_to_veh_on_lane_;
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.DrivingMapInfo_message.nearest_point_to_veh_on_lane)
  return p != nullptr ? *p : *reinterpret_cast<const ::phoenix::ad_data_upload::PathPoint_message*>(
      &::phoenix::ad_data_upload::_PathPoint_message_default_instance_);
}
inline ::phoenix::ad_data_upload::PathPoint_message* DrivingMapInfo_message::release_nearest_point_to_veh_on_lane() {
  // @@protoc_insertion_point(field_release:phoenix.ad_data_upload.DrivingMapInfo_message.nearest_point_to_veh_on_lane)
  
  ::phoenix::ad_data_upload::PathPoint_message* temp = nearest_point_to_veh_on_lane_;
  nearest_point_to_veh_on_lane_ = nullptr;
  return temp;
}
inline ::phoenix::ad_data_upload::PathPoint_message* DrivingMapInfo_message::mutable_nearest_point_to_veh_on_lane() {
  
  if (nearest_point_to_veh_on_lane_ == nullptr) {
    auto* p = CreateMaybeMessage<::phoenix::ad_data_upload::PathPoint_message>(GetArenaNoVirtual());
    nearest_point_to_veh_on_lane_ = p;
  }
  // @@protoc_insertion_point(field_mutable:phoenix.ad_data_upload.DrivingMapInfo_message.nearest_point_to_veh_on_lane)
  return nearest_point_to_veh_on_lane_;
}
inline void DrivingMapInfo_message::set_allocated_nearest_point_to_veh_on_lane(::phoenix::ad_data_upload::PathPoint_message* nearest_point_to_veh_on_lane) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete nearest_point_to_veh_on_lane_;
  }
  ...
  // @@protoc_insertion_point(field_set_allocated:phoenix.ad_data_upload.DrivingMapInfo_message.nearest_point_to_veh_on_lane)
}

// .phoenix.ad_data_upload.MapInfo_message map = 3;
inline bool DrivingMapInfo_message::has_map() const {
  return this != internal_default_instance() && map_ != nullptr;
}
inline void DrivingMapInfo_message::clear_map() {
  if (GetArenaNoVirtual() == nullptr && map_ != nullptr) {
    delete map_;
  }
  map_ = nullptr;
}
inline const ::phoenix::ad_data_upload::MapInfo_message& DrivingMapInfo_message::map() const {
  const ::phoenix::ad_data_upload::MapInfo_message* p = map_;
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.DrivingMapInfo_message.map)
...
inline ::phoenix::ad_data_upload::MapInfo_message* DrivingMapInfo_message::release_map() {
  // @@protoc_insertion_point(field_release:phoenix.ad_data_upload.DrivingMapInfo_message.map)
  
  ::phoenix::ad_data_upload::MapInfo_message* temp = map_;
  map_ = nullptr;
  return temp;
}
inline ::phoenix::ad_data_upload::MapInfo_message* DrivingMapInfo_message::mutable_map() {
  
  if (map_ == nullptr) {
    auto* p = CreateMaybeMessage<::phoenix::ad_data_upload::MapInfo_message>(GetArenaNoVirtual());
    map_ = p;
  }
  // @@protoc_insertion_point(field_mutable:phoenix.ad_data_upload.DrivingMapInfo_message.map)
  return map_;
}
inline void DrivingMapInfo_message::set_allocated_map(::phoenix::ad_data_upload::MapInfo_message* map) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete map_;
  }
  ...
  map_ = map;
  // @@protoc_insertion_point(field_set_allocated:phoenix.ad_data_upload.DrivingMapInfo_message.map)
}

// sint32 current_reference_line_index = 4;
inline void DrivingMapInfo_message::clear_current_reference_line_index() {
  current_reference_line_index_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 DrivingMapInfo_message::current_reference_line_index() const {
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.DrivingMapInfo_message.current_reference_line_index)
  return current_reference_line_index_;
}
inline void DrivingMapInfo_message::set_current_reference_line_index(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  current_reference_line_index_ = value;
  // @@protoc_insertion_point(field_set:phoenix.ad_data_upload.DrivingMapInfo_message.current_reference_line_index)
}

// uint32 reference_lines_count = 5;
inline void DrivingMapInfo_message::clear_reference_lines_count() {
  reference_lines_count_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 DrivingMapInfo_message::reference_lines_count() const {
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.DrivingMapInfo_message.reference_lines_count)
  return reference_lines_count_;
}
inline void DrivingMapInfo_message::set_reference_lines_count(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  reference_lines_count_ = value;
  // @@protoc_insertion_point(field_set:phoenix.ad_data_upload.DrivingMapInfo_message.reference_lines_count)
}

// repeated .phoenix.ad_data_upload.ReferenceLineInfo_message reference_lines = 6;
inline int DrivingMapInfo_message::reference_lines_size() const {
  return reference_lines_.size();
}
inline void DrivingMapInfo_message::clear_reference_lines() {
  reference_lines_.Clear();
}
inline ::phoenix::ad_data_upload::ReferenceLineInfo_message* DrivingMapInfo_message::mutable_reference_lines(int index) {
  // @@protoc_insertion_point(field_mutable:phoenix.ad_data_upload.DrivingMapInfo_message.reference_lines)
...
DrivingMapInfo_message::mutable_reference_lines() {
  // @@protoc_insertion_point(field_mutable_list:phoenix.ad_data_upload.DrivingMapInfo_message.reference_lines)
  return &reference_lines_;
}
inline const ::phoenix::ad_data_upload::ReferenceLineInfo_message& DrivingMapInfo_message::reference_lines(int index) const {
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.DrivingMapInfo_message.reference_lines)
  return reference_lines_.Get(index);
}
inline ::phoenix::ad_data_upload::ReferenceLineInfo_message* DrivingMapInfo_message::add_reference_lines() {
  // @@protoc_insertion_point(field_add:phoenix.ad_data_upload.DrivingMapInfo_message.reference_lines)
...
DrivingMapInfo_message::reference_lines() const {
  // @@protoc_insertion_point(field_list:phoenix.ad_data_upload.DrivingMapInfo_message.reference_lines)
  return reference_lines_;
}

// uint32 road_boundary_count = 7;
inline void DrivingMapInfo_message::clear_road_boundary_count() {
  road_boundary_count_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 DrivingMapInfo_message::road_boundary_count() const {
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.DrivingMapInfo_message.road_boundary_count)
  return road_boundary_count_;
}
inline void DrivingMapInfo_message::set_road_boundary_count(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  road_boundary_count_ = value;
  // @@protoc_insertion_point(field_set:phoenix.ad_data_upload.DrivingMapInfo_message.road_boundary_count)
}

// repeated .phoenix.ad_data_upload.RoadBoundary_message road_boundary = 8;
inline int DrivingMapInfo_message::road_boundary_size() const {
  return road_boundary_.size();
}
inline void DrivingMapInfo_message::clear_road_boundary() {
  road_boundary_.Clear();
}
inline ::phoenix::ad_data_upload::RoadBoundary_message* DrivingMapInfo_message::mutable_road_boundary(int index) {
  // @@protoc_insertion_point(field_mutable:phoenix.ad_data_upload.DrivingMapInfo_message.road_boundary)
...
DrivingMapInfo_message::mutable_road_boundary() {
  // @@protoc_insertion_point(field_mutable_list:phoenix.ad_data_upload.DrivingMapInfo_message.road_boundary)
  return &road_boundary_;
}
inline const ::phoenix::ad_data_upload::RoadBoundary_message& DrivingMapInfo_message::road_boundary(int index) const {
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.DrivingMapInfo_message.road_boundary)
  return road_boundary_.Get(index);
}
inline ::phoenix::ad_data_upload::RoadBoundary_message* DrivingMapInfo_message::add_road_boundary() {
  // @@protoc_insertion_point(field_add:phoenix.ad_data_upload.DrivingMapInfo_message.road_boundary)
  return road_boundary_.Add();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::phoenix::ad_data_upload::RoadBoundary_message >&
DrivingMapInfo_message::road_boundary() const {
  // @@protoc_insertion_point(field_list:phoenix.ad_data_upload.DrivingMapInfo_message.road_boundary)
  return road_boundary_;
}

// uint32 obstacle_list_count = 9;
inline void DrivingMapInfo_message::clear_obstacle_list_count() {
  obstacle_list_count_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 DrivingMapInfo_message::obstacle_list_count() const {
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.DrivingMapInfo_message.obstacle_list_count)
  return obstacle_list_count_;
}
inline void DrivingMapInfo_message::set_obstacle_list_count(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  obstacle_list_count_ = value;
  // @@protoc_insertion_point(field_set:phoenix.ad_data_upload.DrivingMapInfo_message.obstacle_list_count)
}

// repeated .phoenix.ad_data_upload.ObstacleInfo_message obstacle_list = 10;
inline int DrivingMapInfo_message::obstacle_list_size() const {
  return obstacle_list_.size();
}
inline void DrivingMapInfo_message::clear_obstacle_list() {
  obstacle_list_.Clear();
}
inline ::phoenix::ad_data_upload::ObstacleInfo_message* DrivingMapInfo_message::mutable_obstacle_list(int index) {
  // @@protoc_insertion_point(field_mutable:phoenix.ad_data_upload.DrivingMapInfo_message.obstacle_list)
...
DrivingMapInfo_message::mutable_obstacle_list() {
  // @@protoc_insertion_point(field_mutable_list:phoenix.ad_data_upload.DrivingMapInfo_message.obstacle_list)
  return &obstacle_list_;
}
inline const ::phoenix::ad_data_upload::ObstacleInfo_message& DrivingMapInfo_message::obstacle_list(int index) const {
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.DrivingMapInfo_message.obstacle_list)
  return obstacle_list_.Get(index);
}
inline ::phoenix::ad_data_upload::ObstacleInfo_message* DrivingMapInfo_message::add_obstacle_list() {
  // @@protoc_insertion_point(field_add:phoenix.ad_data_upload.DrivingMapInfo_message.obstacle_list)
  return obstacle_list_.Add();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::phoenix::ad_data_upload::ObstacleInfo_message >&
DrivingMapInfo_message::obstacle_list() const {
  // @@protoc_insertion_point(field_list:phoenix.ad_data_upload.DrivingMapInfo_message.obstacle_list)
  return obstacle_list_;
}

// uint32 risky_obj_list_count = 11;
inline void DrivingMapInfo_message::clear_risky_obj_list_count() {
  risky_obj_list_count_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 DrivingMapInfo_message::risky_obj_list_count() const {
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.DrivingMapInfo_message.risky_obj_list_count)
  return risky_obj_list_count_;
}
inline void DrivingMapInfo_message::set_risky_obj_list_count(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  risky_obj_list_count_ = value;
  // @@protoc_insertion_point(field_set:phoenix.ad_data_upload.DrivingMapInfo_message.risky_obj_list_count)
}

// repeated .phoenix.ad_data_upload.ObjInfo_message risky_obj_list = 12;
inline int DrivingMapInfo_message::risky_obj_list_size() const {
  return risky_obj_list_.size();
}
inline void DrivingMapInfo_message::clear_risky_obj_list() {
  risky_obj_list_.Clear();
}
inline ::phoenix::ad_data_upload::ObjInfo_message* DrivingMapInfo_message::mutable_risky_obj_list(int index) {
  // @@protoc_insertion_point(field_mutable:phoenix.ad_data_upload.DrivingMapInfo_message.risky_obj_list)
  return risky_obj_list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::phoenix::ad_data_upload::ObjInfo_message >*
DrivingMapInfo_message::mutable_risky_obj_list() {
  // @@protoc_insertion_point(field_mutable_list:phoenix.ad_data_upload.DrivingMapInfo_message.risky_obj_list)
  return &risky_obj_list_;
}
inline const ::phoenix::ad_data_upload::ObjInfo_message& DrivingMapInfo_message::risky_obj_list(int index) const {
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.DrivingMapInfo_message.risky_obj_list)
  return risky_obj_list_.Get(index);
}
inline ::phoenix::ad_data_upload::ObjInfo_message* DrivingMapInfo_message::add_risky_obj_list() {
  // @@protoc_insertion_point(field_add:phoenix.ad_data_upload.DrivingMapInfo_message.risky_obj_list)
  return risky_obj_list_.Add();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::phoenix::ad_data_upload::ObjInfo_message >&
DrivingMapInfo_message::risky_obj_list() const {
  // @@protoc_insertion_point(field_list:phoenix.ad_data_upload.DrivingMapInfo_message.risky_obj_list)
  return risky_obj_list_;
}

// uint32 uncertain_list_count = 13;
inline void DrivingMapInfo_message::clear_uncertain_list_count() {
  uncertain_list_count_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 DrivingMapInfo_message::uncertain_list_count() const {
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.DrivingMapInfo_message.uncertain_list_count)
  return uncertain_list_count_;
}
inline void DrivingMapInfo_message::set_uncertain_list_count(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  uncertain_list_count_ = value;
  // @@protoc_insertion_point(field_set:phoenix.ad_data_upload.DrivingMapInfo_message.uncertain_list_count)
}

// repeated .phoenix.ad_data_upload.ObjInfo_message uncertain_list = 14;
inline int DrivingMapInfo_message::uncertain_list_size() const {
  return uncertain_list_.size();
}
inline void DrivingMapInfo_message::clear_uncertain_list() {
  uncertain_list_.Clear();
}
inline ::phoenix::ad_data_upload::ObjInfo_message* DrivingMapInfo_message::mutable_uncertain_list(int index) {
  // @@protoc_insertion_point(field_mutable:phoenix.ad_data_upload.DrivingMapInfo_message.uncertain_list)
  return uncertain_list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::phoenix::ad_data_upload::ObjInfo_message >*
DrivingMapInfo_message::mutable_uncertain_list() {
  // @@protoc_insertion_point(field_mutable_list:phoenix.ad_data_upload.DrivingMapInfo_message.uncertain_list)
  return &uncertain_list_;
}
inline const ::phoenix::ad_data_upload::ObjInfo_message& DrivingMapInfo_message::uncertain_list(int index) const {
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.DrivingMapInfo_message.uncertain_list)
  return uncertain_list_.Get(index);
}
inline ::phoenix::ad_data_upload::ObjInfo_message* DrivingMapInfo_message::add_uncertain_list() {
  // @@protoc_insertion_point(field_add:phoenix.ad_data_upload.DrivingMapInfo_message.uncertain_list)
  return uncertain_list_.Add();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::phoenix::ad_data_upload::ObjInfo_message >&
DrivingMapInfo_message::uncertain_list() const {
  // @@protoc_insertion_point(field_list:phoenix.ad_data_upload.DrivingMapInfo_message.uncertain_list)
  return uncertain_list_;
}

// .phoenix.ad_data_upload.FollowingTarget_message following_target = 15;
inline bool DrivingMapInfo_message::has_following_target() const {
  return this != internal_default_instance() && following_target_ != nullptr;
}
inline void DrivingMapInfo_message::clear_following_target() {
  if (GetArenaNoVirtual() == nullptr && following_target_ != nullptr) {
    delete following_target_;
  }
  following_target_ = nullptr;
}
inline const ::phoenix::ad_data_upload::FollowingTarget_message& DrivingMapInfo_message::following_target() const {
  const ::phoenix::ad_data_upload::FollowingTarget_message* p = following_target_;
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.DrivingMapInfo_message.following_target)
...
inline ::phoenix::ad_data_upload::FollowingTarget_message* DrivingMapInfo_message::release_following_target() {
  // @@protoc_insertion_point(field_release:phoenix.ad_data_upload.DrivingMapInfo_message.following_target)
  
  ::phoenix::ad_data_upload::FollowingTarget_message* temp = following_target_;
  following_target_ = nullptr;
  return temp;
}
inline ::phoenix::ad_data_upload::FollowingTarget_message* DrivingMapInfo_message::mutable_following_target() {
  
  if (following_target_ == nullptr) {
    auto* p = CreateMaybeMessage<::phoenix::ad_data_upload::FollowingTarget_message>(GetArenaNoVirtual());
    following_target_ = p;
  }
  // @@protoc_insertion_point(field_mutable:phoenix.ad_data_upload.DrivingMapInfo_message.following_target)
  return following_target_;
}
inline void DrivingMapInfo_message::set_allocated_following_target(::phoenix::ad_data_upload::FollowingTarget_message* following_target) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete following_target_;
  }
  ...
  // @@protoc_insertion_point(field_set_allocated:phoenix.ad_data_upload.DrivingMapInfo_message.following_target)
}
...
// .phoenix.ad_data_upload.DrivingMapInfo_message driving_map_info = 1;
inline bool PathPln_Display_Data_message::has_driving_map_info() const {
  return this != internal_default_instance() && driving_map_info_ != nullptr;
}
inline void PathPln_Display_Data_message::clear_driving_map_info() {
  if (GetArenaNoVirtual() == nullptr && driving_map_info_ != nullptr) {
    delete driving_map_info_;
  }
  driving_map_info_ = nullptr;
}
inline const ::phoenix::ad_data_upload::DrivingMapInfo_message& PathPln_Display_Data_message::driving_map_info() const {
  const ::phoenix::ad_data_upload::DrivingMapInfo_message* p = driving_map_info_;
  // @@protoc_insertion_point(field_get:phoenix.ad_data_upload.PathPln_Display_Data_message.driving_map_info)
  return p != nullptr ? *p : *reinterpret_cast<const ::phoenix::ad_data_upload::DrivingMapInfo_message*>(
      &::phoenix::ad_data_upload::_DrivingMapInfo_message_default_instance_);
}
inline ::phoenix::ad_data_upload::DrivingMapInfo_message* PathPln_Display_Data_message::release_driving_map_info() {
  // @@protoc_insertion_point(field_release:phoenix.ad_data_upload.PathPln_Display_Data_message.driving_map_info)
  
  ::phoenix::ad_data_upload::DrivingMapInfo_message* temp = driving_map_info_;
  driving_map_info_ = nullptr;
  return temp;
}
inline ::phoenix::ad_data_upload::DrivingMapInfo_message* PathPln_Display_Data_message::mutable_driving_map_info() {
  
  if (driving_map_info_ == nullptr) {
    auto* p = CreateMaybeMessage<::phoenix::ad_data_upload::DrivingMapInfo_message>(GetArenaNoVirtual());
    driving_map_info_ = p;
  }
  // @@protoc_insertion_point(field_mutable:phoenix.ad_data_upload.PathPln_Display_Data_message.driving_map_info)
  return driving_map_info_;
}
inline void PathPln_Display_Data_message::set_allocated_driving_map_info(::phoenix::ad_data_upload::DrivingMapInfo_message* driving_map_info) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete driving_map_info_;
  }
  if (driving_map_info) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena = nullptr;
    if (message_arena != submessage_arena) {
      driving_map_info = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, driving_map_info, submessage_arena);
    }
    
  } else {
    
  }
  driving_map_info_ = driving_map_info;
  // @@protoc_insertion_point(field_set_allocated:phoenix.ad_data_upload.PathPln_Display_Data_message.driving_map_info)
}
