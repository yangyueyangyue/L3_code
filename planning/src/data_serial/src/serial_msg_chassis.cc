...
Int32_t EncodeChassisArray(
  ...
  for (Int32_t i = 0; i < elements; ++i) {
    ...
    thislen = common::EncodeValueArray(buf, offset + pos, maxlen - pos,
                                       &(p[i].gross_weight_valid), 1);
    if (thislen < 0) {
      LOG_ERR << "Failed to encode \"gross_weight_valid\" of Chassis["
              << i << "].";
      return (thislen);
    } else {
      pos += thislen;
    ...
    thislen = common::EncodeValueArray(buf, offset + pos, maxlen - pos,
                                       &(p[i].gross_weight), 1);
    if (thislen < 0) {
      LOG_ERR << "Failed to encode \"gross_weight\" of Chassis["
              << i << "].";
      return (thislen);
    } else {
      pos += thislen;
    ...
    thislen = common::EncodeValueArray(buf, offset + pos, maxlen - pos,
                                       &(p[i].trailer_status), 1);
    if (thislen < 0) {
      LOG_ERR << "Failed to encode \"trailer_status\" of Chassis["
              << i << "].";
      return (thislen);
    } else {
      pos += thislen;
...
Int32_t DecodeChassisArray(
  ...
  for (Int32_t i = 0; i < elements; ++i) {
    ...
    thislen = common::DecodeValueArray(buf, offset + pos, maxlen - pos,
                                       &(p[i].gross_weight_valid), 1);
    if (thislen < 0) {
      LOG_ERR << "Failed to decode \"gross_weight_valid\" of Chassis["
              << i << "].";
      return (thislen);
    } else {
      pos += thislen;
    ...
    thislen = common::DecodeValueArray(buf, offset + pos, maxlen - pos,
                                       &(p[i].gross_weight), 1);
    if (thislen < 0) {
      LOG_ERR << "Failed to decode \"gross_weight\" of Chassis["
              << i << "].";
      return (thislen);
    } else {
      pos += thislen;
    ...
    thislen = common::DecodeValueArray(buf, offset + pos, maxlen - pos,
                                       &(p[i].trailer_status), 1);
    if (thislen < 0) {
      LOG_ERR << "Failed to decode \"trailer_status\" of Chassis["
              << i << "].";
      return (thislen);
    } else {
      pos += thislen;
