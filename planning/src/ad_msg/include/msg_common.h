...
enum {
  ...
  SUB_MODULE_ID_MOTION_PLANNING_RECV_MSG_OBSTACLE_CAMGENERAL_FRONT_LIST,
  SUB_MODULE_ID_MOTION_PLANNING_RECV_MSG_OBSTACLE_CAMGENERAL_LEFT_FRONT_LIST,
  SUB_MODULE_ID_MOTION_PLANNING_RECV_MSG_OBSTACLE_CAMGENERAL_RIGHT_FRONT_LIST,
  SUB_MODULE_ID_MOTION_PLANNING_RECV_MSG_OBSTACLE_CAMGENERAL_REAR_LIST,
  SUB_MODULE_ID_MOTION_PLANNING_RECV_MSG_OBSTACLE_CAMGENERAL_LEFT_REAR_LIST,
  SUB_MODULE_ID_MOTION_PLANNING_RECV_MSG_OBSTACLE_CAMGENERAL_RIGHT_REAR_LIST,
