...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_ClearArea_modules_2fmap_2fproto_2fmap_5fclear_5farea_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsscc_info_ClearArea_modules_2fmap_2fproto_2fmap_5fclear_5farea_2eproto}, {
...
void ClearArea::SerializeWithCachedSizes(
  ...
  if (cached_has_bits & 0x00000002u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteMessageMaybeToArray(
      3, _Internal::polygon(this), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* ClearArea::InternalSerializeWithCachedSizesToArray(
  ...
  if (cached_has_bits & 0x00000002u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(
        3, _Internal::polygon(this), target);
  }
