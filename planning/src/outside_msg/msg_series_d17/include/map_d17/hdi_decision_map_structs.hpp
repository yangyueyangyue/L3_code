...
{
    LaneIndex   m_initialLane   = INVALID_LANE_INDEX;   ///< 当前车道编号
    PathId      m_initialPath   = INVALID_PATHID;       ///< 当前的路径编号
    LaneIndex   m_newLane       = INVALID_LANE_INDEX;   ///< 脱出的车道编号
    PathId      m_newPath       = INVALID_PATHID;       ///< 脱出的路径编号
};
