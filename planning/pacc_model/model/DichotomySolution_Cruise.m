function [lambda,v_i,v_1,Te_1,Te_2] = DichotomySolution_Cruise(lambda_ini,s_0,vd_0,v_0,ig_0,i_alpha_ini,alpha_ini,count_alpha,alpha_r,s_alpha,count_v,s_v,v_min_r,v_max_r,v_min,v_max)
% ---车辆固有参数---
global Veh_Para
CD=Veh_Para(1);
Af=Veh_Para(2);
...
L22=FuelRate_Para(9);
% ---控制器参数，待标定---
global Cruise_Con_Para
kappa_1=Cruise_Con_Para(1);%速度跟踪性指标权重系数
Delta_t=Cruise_Con_Para(3);%离散化间隔
Np=Cruise_Con_Para(5);%预测时域离散点数
%% 初始发动机力矩约束
