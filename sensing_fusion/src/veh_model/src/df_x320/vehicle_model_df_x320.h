 ...
 ******************************************************************************/
#ifndef PHOENIX_VEH_MODEL_VEHICLE_MODEL_DF_X320_H_
#define PHOENIX_VEH_MODEL_VEHICLE_MODEL_DF_X320_H_
...
class VehicleModelDfX320 : public VehicleModelBase {
public:
  typedef VehicleModelBase::Scalar Scalar;
  typedef VehicleModelBase Base;

public:
  virtual ~VehicleModelDfX320();
...
private:
  DECLARE_SINGLETON(VehicleModelDfX320);
};
...
#endif  // PHOENIX_VEH_MODEL_VEHICLE_MODEL_DF_X320_H_
