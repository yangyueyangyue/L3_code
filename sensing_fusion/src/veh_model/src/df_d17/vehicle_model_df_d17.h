 ...
 ******************************************************************************/
#ifndef PHOENIX_VEH_MODEL_VEHICLE_MODEL_DF_D17_H_
#define PHOENIX_VEH_MODEL_VEHICLE_MODEL_DF_D17_H_
...
class VehicleModelDfD17 : public VehicleModelBase {
public:
  typedef VehicleModelBase::Scalar Scalar;
  typedef VehicleModelBase Base;

public:
  virtual ~VehicleModelDfD17();
...
private:
  DECLARE_SINGLETON(VehicleModelDfD17);
};
...
#endif  // PHOENIX_VEH_MODEL_VEHICLE_MODEL_DF_D17_H_
