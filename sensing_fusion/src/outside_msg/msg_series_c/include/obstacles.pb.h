...
enum Obstacle_PerceptionType : int {
  ...
  Obstacle_PerceptionType_OBJ_PRCP_TYPE_LIDAR = 4
};
...
constexpr Obstacle_PerceptionType Obstacle_PerceptionType_PerceptionType_MAX = Obstacle_PerceptionType_OBJ_PRCP_TYPE_LIDAR;
...
class Obstacle :
 ...
 public:
  ...
  static constexpr PerceptionType OBJ_PRCP_TYPE_LIDAR =
    Obstacle_PerceptionType_OBJ_PRCP_TYPE_LIDAR;
