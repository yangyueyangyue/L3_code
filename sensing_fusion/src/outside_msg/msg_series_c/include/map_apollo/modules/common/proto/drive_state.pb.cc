...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_EngageAdvice_modules_2fcommon_2fproto_2fdrive_5fstate_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_EngageAdvice_modules_2fcommon_2fproto_2fdrive_5fstate_2eproto}, {}};
...
static bool descriptor_table_modules_2fcommon_2fproto_2fdrive_5fstate_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fcommon_2fproto_2fdrive_5fstate_2eproto = {
  &descriptor_table_modules_2fcommon_2fproto_2fdrive_5fstate_2eproto_initialized, descriptor_table_protodef_modules_2fcommon_2fproto_2fdrive_5fstate_2eproto, "modules/common/proto/drive_state.proto", 263,
...
static bool dynamic_init_dummy_modules_2fcommon_2fproto_2fdrive_5fstate_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_modules_2fcommon_2fproto_2fdrive_5fstate_2eproto), true);
namespace apollo {
namespace common {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          if (PROTOBUF_PREDICT_TRUE(::apollo::common::EngageAdvice_Advice_IsValid(val))) {
            set_advice(static_cast<::apollo::common::EngageAdvice_Advice>(val));
          } else {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(mutable_reason(), ptr, ctx, "apollo.common.EngageAdvice.reason");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* EngageAdvice::InternalSerializeWithCachedSizesToArray(
...
// @@protoc_insertion_point(message_byte_size_start:apollo.common.EngageAdvice)
  ...
  if (cached_has_bits & 0x00000003u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      total_size += 1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::EnumSize(this->advice());
    }
