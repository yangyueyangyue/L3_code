...
bool ParseProtoMsg::EncodeObstacleLidarListMessage(
  ...
  case (ad_msg::ObstacleLidarList::LIDAR_TYPE_ROBOSENSE_M1):
    data_out->set_lidar_type(msg::perception::ObstacleLidarList::LIDAR_TYPE_ROBOSENSE_M1);
    break;
  default:
...
bool ParseProtoMsg::DecodeObstacleLidarListMessage(
  ...
  case (msg::perception::ObstacleLidarList::LIDAR_TYPE_VLP_16):
    ...
    break;
  case (msg::perception::ObstacleLidarList::LIDAR_TYPE_ROBOSENSE_M1):
      data_out->lidar_type = ad_msg::ObstacleLidarList::LIDAR_TYPE_ROBOSENSE_M1;
      break;
  default:
...
bool ParseProtoMsg::EncodeLidarCloudMessage(
  ...
  case (ad_msg::ObstacleLidarList::LIDAR_TYPE_VLP_16):
    ...
    break;
  case (ad_msg::ObstacleLidarList::LIDAR_TYPE_ROBOSENSE_M1):
    data_out->set_lidar_type(msg::perception::LidarCloud::LIDAR_TYPE_ROBOSENSE_M1);
    break;
  default:
...
bool ParseProtoMsg::DecodeLidarCloudMessage(
  ...
  case (msg::perception::LidarCloud::LIDAR_TYPE_VLP_16):
    ...
    break;
  case (msg::perception::LidarCloud::LIDAR_TYPE_ROBOSENSE_M1):
    data_out->lidar_type = ad_msg::LidarCloud::LIDAR_TYPE_ROBOSENSE_M1;
    break;
  default:
